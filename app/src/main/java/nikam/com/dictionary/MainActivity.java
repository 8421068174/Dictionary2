            ...
            case R.id.menu_home:
               // Toast.makeText(MainActivity.this, "Home Menu", Toast.LENGTH_SHORT).show();
                   HomeFragment home=new HomeFragment();
                    ...
                    ft.replace(R.id.content_main,home);
                    ft.commit();
                break;

            case R.id.menu_favorite:
               // Toast.makeText(MainActivity.this, "Favorite Menu", Toast.LENGTH_SHORT).show();
                FavoriteFragment favorite=new FavoriteFragment();

                android.support.v4.app.FragmentTransaction ft1 =
                        getSupportFragmentManager().beginTransaction();
                ft1.replace(R.id.content_main,favorite);
                ft1.commit();
                break;
